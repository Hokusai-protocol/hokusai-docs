...
- Performance verified on-chain by **DeltaVerifier** using **HEM** (Hokusai Evaluation Manifest) per-row eval artifacts stored in MLflow; accepted improvements publish a **MintRequest** (schema v1.0) to Redis
